...
<div class="row">
	...
	<div class="six columns img_detalhes">
		<div class="slider-wrapper theme-default">
			<div id="slider" class="nivoSlider detailslider">
				<img src="images/destinos/capitolio.jpg" data-thumb="" alt=""/>
			...
			<ul class="tabs-content">
					...
					<div class="columns noleftmargin">
						...
						<p>
							<span><b>*No embarque será obrigatório apresentar o documento de identidade original,
								e na impossibilidade do embarque por falta de documentação adequada ou atrasos referentes
								aos horários estipulados será considerada desistência e nos isenta de quaisquer reembolsos
								dos valores pagos.</b></span>
						</p>
					</div>
				</li>
				<li id="simple3Tab">
				...
				<p>
					...
					<span><b><i>*Pagamento completo através de Cartão de Crédito existe um acréscimo de 7% da taxa + o juros do PagSeguro.
						Aceitamos cartão somente até o dia 05/09.</i></b></span>
				</p>
				<p>
	...
	<a href="pre_reserva.php?destino=Capitólio">
